...
import weatherpkg.DayStats;
import weatherpkg.TempData;
import weatherpkg.WindData;
...
public class Predictor extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{			
			...
			String responseLabelValue = "hello there "+name;
			...
			response.getWriter().append("<br>Hey:"+name);
		}
	}
